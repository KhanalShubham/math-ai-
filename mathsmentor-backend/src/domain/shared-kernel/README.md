# shared-kernel — scaffolded, no business logic yet

Value objects shared across modules (e.g. Grade, Topic references) — kept minimal, added only when real duplication appears.
